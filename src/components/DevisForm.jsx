...
function DevisForm({ onSubmit, loading, clients = [], products = [] }) {
            ...
            <form className="card__body" onSubmit={handleSubmit}>
                ...
                {clients.length > 0 && (
                    <div className="form-group">
                        <label className="form-label" htmlFor="devisClientSelect">Sélectionner un client existant</label>
                        <select
                            id="devisClientSelect"
                ...
                <div className="form-row">
                    <div className="form-group">
                        <label className="form-label" htmlFor="devisClientName">Nom du client *</label>
                        <input
                            type="text"
                            id="devisClientName"
                            name="clientName"
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="devisClientEmail">E-mail</label>
                        <input
                            type="email"
                            id="devisClientEmail"
                            name="clientEmail"
                ...
                <div className="form-row">
                    <div className="form-group">
                        <label className="form-label" htmlFor="devisClientAddress">Adresse</label>
                        <input
                            type="text"
                            id="devisClientAddress"
                            name="clientAddress"
                            className="form-input"
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="devisValidUntil">Valide jusqu'au</label>
                        <input
                            type="date"
                            id="devisValidUntil"
                            name="validUntil"
                ...
                <div className="invoice-summary">
                    ...
                    <div className="summary-row summary-row--total">
                        <span className="summary-row__label">Total estimé :</span>
                ...
                <div className="form-group" style={{ marginTop: '1.5rem' }}>
                    <label className="form-label" htmlFor="devisNotes">Notes</label>
                    <textarea
                        id="devisNotes"
                        name="notes"
